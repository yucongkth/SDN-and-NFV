...
src_eth1 :: FromDevice(s6-eth1£¬METHOD LINUX, SNIFFER false);
src_eth3 :: FromDevice(s6-eth3£¬METHOD LINUX, SNIFFER false);

dst_eth1 :: Queue -> OutputRateEth1 -> ToDevice(s6-eth1);
dst_eth2 :: Queue -> OutputRateEth2 -> ToDevice(s6-eth3);
dst_insp :: Queue -> OutputRateEth3 -> ToDevice(s6-eth2);
...
src_eth3 -> InputRateEth2 ->dst_eth1;
