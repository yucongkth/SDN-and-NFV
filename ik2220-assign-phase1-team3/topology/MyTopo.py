...
class MyTopo(Topo):	
	...
	# private zone
		...
		h3=self.addHost('h3',ip='100.0.0.50/24',mac='00:00:00:00:00:50', defaultRoute='via 10.0.0.1')
		h4=self.addHost('h4',ip='100.0.0.51/24', mac='00:00:00:00:00:51', defaultRoute='via 10.0.0.1')
